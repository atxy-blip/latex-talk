...
\setbeamertemplate{title graphic}{%
  \vbox to 0pt {\smash{\raisebox{-140pt}{\inserttitlegraphic}}}%
  \nointerlineskip}
...
\newfontfamily\Avenir{Avenir Next W1G}
...
\newfontfamily\SimHei{SimHei}[AutoFakeBold=4, AutoFakeSlant]%{simhei.ttf}[Path=./fonts/, AutoFakeBold=4, AutoFakeSlant]
\newfontfamily\TimesNewRoman{Times New Roman}
\newfontfamily\xkcd{xkcd Script}[Ligatures=TeX]%{xkcd-script.ttf}[Path=./fonts/, Ligatures=TeX]
...
\author{熊煜}
\institute{南京大学\\ 化学化工学院}
\date{\zhtoday}
\titlegraphic{\qrcode[hyperlink, height=1.6cm]{https://github.com/atxy-blip/latex-talk/}\njuemblem[white!85!gray]{12cm}{!}}
