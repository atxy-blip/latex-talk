...
\begin{column}{0.3\textwidth}
  \begin{figure}
    \centering
    \njuemblem{0.6\textwidth}{!}
    \caption{\textcolor{keyword}{Figure \thefigure:} Logo of Nanjing University}
    \label{fig:nju-logo_}  % Avoid duplicate labels warning
  \end{figure}
\end{column}
\end{columns}
\end{frame}
...
\begin{itemize}
  ...
  \item<+-> 以标签控制交叉引用
    ...
    \begin{itemize}
      \item 被引处：|\label|
      \item 引用处：|\ref|、|\eqref| 等（如图~\textcolor{emph1}{\ref{fig:nju-logo_}}、
